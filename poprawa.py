...
def generate_data_row(imiona, nazwiska, ulice, miasta, kraje):
...
def main():
    ...
    dane = set()
    while len(dane) < liczba_wierszy:
        dane.add(tuple(generate_data_row(imiona, nazwiska, ulice, miasta, kraje)))
